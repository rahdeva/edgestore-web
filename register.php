        ...
        <div class="max-w-lg border-slate-200 rounded-xl shadow-2xl shadow-blue-500 font-inter p-5 bg-white">
            <form action="" method="post">
                <label for="nama">
                    ...
                    <input type="text" required  name="nama_depan" placeholder="Masukkan nama depan..." class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500"/>   
                </label>
                <label for="nama">
                    <span class="block font-semibold mb-1 text-slate-700 after:content-['*'] after:text-pink-500 after:ml-1 mt-3">Nama Belakang</span>
                    <input type="text"required name="nama_belakang"placeholder="Masukkan nama belakang..." class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 "/>   
                </label>
                <label for="alamat">
